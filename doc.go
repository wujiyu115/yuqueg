...
// List doc of a repo
func (doc Doc) List(namespace string) (interface{}, error) {
	if len(namespace) == 0 {
...
func (doc Doc) Get(namespace string, slug string, data *DocGet) (interface{}, error) {
	if len(namespace) == 0 {
		return nil, errors.New("repo namespace or id is required")
	}
...
// Create doc
func (doc Doc) Create(namespace string, data *DocCreate) (interface{}, error) {
	if len(namespace) == 0 {
		return nil, errors.New("repo namespace or id is required")
	}
...
// Update doc
func (doc Doc) Update(namespace string, id string, data *DocCreate) (interface{}, error) {
	if len(namespace) == 0 {
		return nil, errors.New("repo namespace or id is required")
	}
	if len(id) == 0 {
...
// Delete doc
func (doc Doc) Delete(namespace string, id string) (interface{}, error) {
	if len(namespace) == 0 {
		return nil, errors.New("repo namespace or id is required")
	}
	if len(id) == 0 {
